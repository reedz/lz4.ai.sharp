    ...
    public class FramePicklerBenchmarks
    {
        ...
        public void Setup()
        {
            ...
            _framePrefs = new LZ4Frame.FramePreferences
            {
                ...
                // Default block size (64KB) keeps framing overhead realistic for JSON payloads.
        ...
        [Benchmark(Description = "K4os LZ4Pickler - Compress 100", Baseline = true)]
        public long CompressAllPickles()
        {
            ...
            {
                var payload = _payloads[i];
                total += LZ4Pickler.Pickle(payload, (LZ4Level)CompressionLevel).Length;
            }
            return total;
        }

        [Benchmark(Description = "LZ4Sharp LZ4Frame - Decompress 100")]
        ...
        [Benchmark(Description = "K4os LZ4Pickler - Decompress 100")]
